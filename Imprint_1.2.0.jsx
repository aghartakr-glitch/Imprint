              ...
              {isDone && (
                <>
                  ...
                  <div style={{ display:"flex", borderBottom:`1px solid ${T.border}`, padding:"0 24px", background:T.surface }}>
                    {[["preview","미리보기"],["sty","imprint-style.sty"],["code","main.tex"]].map(([key,label]) => (
                  ...
                  {tab === "sty" && styCode && (
                    <div style={{ padding:"20px 24px" }}>
                      <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:12 }}>
                        ...
                        <span style={{ fontSize:11, color:T.muted }}>
                          Overleaf에 업로드 — 본문 길이와 무관하게 동일 스타일 적용
                        </span>
                        <div style={{ flex:1 }} />
                        <button onClick={() => { navigator.clipboard.writeText(styCode); }}
                          style={{ padding:"5px 12px", fontSize:11, fontWeight:600,
                            border:`1px solid ${T.border}`, borderRadius:5,
                            background:T.surface, cursor:"pointer", fontFamily:T.sans }}>
                          Copy .sty
                        </button>
                      </div>
                      <pre style={{ fontFamily:T.mono, fontSize:11, lineHeight:1.65,
                        background:T.code, padding:"16px 20px", borderRadius:8,
                        border:`1px solid ${T.border}`, whiteSpace:"pre-wrap",
                        wordBreak:"break-all", color:T.ink, margin:0, overflowX:"auto" }}>
                        {styCode}
                      </pre>
                      <div style={{ marginTop:10, fontSize:11, color:T.muted, lineHeight:1.7 }}>
                        <strong style={{ color:T.ink }}>사용법:</strong>{" "}
                        1) Overleaf 프로젝트에 <code style={{ background:T.tagBg, padding:"1px 4px", borderRadius:3 }}>imprint-style.sty</code> 업로드{" "}
                        → 2) <code style={{ background:T.tagBg, padding:"1px 4px", borderRadius:3 }}>main.tex</code> 탭의 코드로 조판{" "}
                        → 3) 폰트 파일 5종도 함께 업로드
                      </div>
                    </div>
                  )}
